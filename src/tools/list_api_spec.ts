...
export function createListApiSpecTool(openApiSpec: OpenAPISpec): ToolHandler {
  return {
    definition: {
      name: "list_api_spec",
      description: "List all available Metabase API endpoints from the specification. This tool works with the API documentation, not actual API calls.",
      inputSchema: {
        type: "object",
        properties: {
          category: {
